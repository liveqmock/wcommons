...
public class DateUtilsTests {
	...
	public void testFormatDate() {
		...
		final Date date = wcommons.lang.DateUtils.parseDate(strDate);
		Assert.assertEquals(strDate, wcommons.lang.DateUtils.formatDate(date));
	}
	...
	public void testFormatDate2() {
		...
		final Date date = wcommons.lang.DateUtils.parseDate(strDate);
		Assert.assertEquals("2013-08-01", wcommons.lang.DateUtils.formatDate(date));
	}
